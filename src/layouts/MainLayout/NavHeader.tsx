  ...
  return (
    <div className='flex justify-end gap-3'>
      ...
      {isAuthenticated && (
        ...
        >
          <div className='flex cursor-pointer items-center py-1 hover:text-white/70 gap-1'>
            <div className='w-6 h-6  flex-shrink-0'>
              <img
                src='https://down-vn.img.susercontent.com/file/014c42511f2ed4902f394fd5fab163c5_tn'
                alt='avt'
